<?php /*a:4:{s:95:"D:\wampserver\www\ThinkCMF\public/themes/admin_simpleboot3/admin\theme\file_widget_setting.html";i:1557818809;s:85:"D:\wampserver\www\ThinkCMF\public/themes/admin_simpleboot3/admin\theme\functions.html";i:1557818809;s:77:"D:\wampserver\www\ThinkCMF\public/themes/admin_simpleboot3/public\header.html";i:1557818809;s:83:"D:\wampserver\www\ThinkCMF\public/themes/admin_simpleboot3/admin\theme\scripts.html";i:1557818809;}*/ ?>
<?php 
...
<body>
<?php if(!(empty($has_file) || (($has_file instanceof \think\Collection || $has_file instanceof \think\Paginator ) && $has_file->isEmpty()))): ?>
    <div class="wrap">
        ...
        <form method="post" class="js-ajax-form  margin-top-20" action="<?php echo url('theme/settingPost'); ?>">
            <div class="list-group">
                <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Nav/index'); ?>','导航管理')" class="list-group-item">导航管理</a>
                <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Slide/index'); ?>','幻灯片管理')"
                   class="list-group-item">幻灯片管理</a>
                <a href="javascript:parent.openIframeLayer('<?php echo url('admin/Link/index'); ?>','友情链接管理')"
                   class="list-group-item">友情链接管理</a>
            </div>

            <?php if(!(empty($has_widget) || (($has_widget instanceof \think\Collection || $has_widget instanceof \think\Paginator ) && $has_widget->isEmpty()))): if(is_array($files) || $files instanceof \think\Collection || $files instanceof \think\Paginator): if( count($files)==0 ) : echo "" ;else: foreach($files as $key=>$file): if(!(empty($file['more']['widgets']) || (($file['more']['widgets'] instanceof \think\Collection || $file['more']['widgets'] instanceof \think\Paginator ) && $file['more']['widgets']->isEmpty()))): ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <input class="form-control-widget-title" type="text" value="<?php echo $widget['title']; ?>"
                                               name="files[<?php echo $file['id']; ?>][widget][<?php echo $widgetName; ?>][title]">
                                        <label class="checkbox-inline pull-right">
                                            <?php $display_checked=empty($widget['display'])?'':'checked'; ?>
                                            <input type="checkbox"
                                                   name="files[<?php echo $file['id']; ?>][widget][<?php echo $widgetName; ?>][display]"
                                                   value="1"
                                    ...
                                    <div id="collapse-<?php echo $widgetName; ?>" class="panel-collapse collapse in" role="tabpanel">
                                        <div class="panel-body">
                                            <?php echo _parse_vars($widget['vars'],'files['.$file['id'].'][widget_vars]['.$widgetName.']',1,$widgetName,$file['id']); if(!(empty($file['is_public']) || (($file['is_public'] instanceof \think\Collection || $file['is_public'] instanceof \think\Paginator ) && $file['is_public']->isEmpty()))): ?>
...
<?php endif; if(empty($has_file) || (($has_file instanceof \think\Collection || $has_file instanceof \think\Paginator ) && $has_file->isEmpty())): ?>
    <script>
